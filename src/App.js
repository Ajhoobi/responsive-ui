...
function App() {
  ...
  // Use useCallback to memoize handleDocumentClick
        ...
        <Grid item lg={9} md={8} xs={10} sm={11} style={{ padding: '20px' }} id="grid-container">
          ...
          <Grid id="card-grid" gap={3}>
            <Grid item lg={4} md={4} xs={12}>
              <Card className="card">
                <CardContent>
                  <Typography variant="h6" className="card-title"><b> Basic</b></Typography>
                  <Typography variant="subtitle2" className="old-price">$89.99/{isMonthly ? 'mo' : 'yr'}</Typography>
              ...
              <Card className="card-card-wide">
                <CardContent id="card-div">
                  <div>
                    ...
                    <Typography variant="h6" className="card-title">Free Starter</Typography>
                    <Typography variant="subtitle1">The quickest and easiest way to try protocols with basic functionalities</Typography>
                  ...
                  <div>
                    <List>
                      ...
                      <ListItem>
                        <ListItemText><FontAwesomeIcon icon={faUser} /> Upto 8 users</ListItemText>
                      </ListItem>
                      <ListItem>
                        <ListItemText><FontAwesomeIcon icon={faHdd} /> Upto 3gb Storage</ListItemText>
                      </ListItem>
                      <ListItem>
                        <ListItemText><FontAwesomeIcon icon={faEnvelope} /> Email support</ListItemText>
                      </ListItem>
